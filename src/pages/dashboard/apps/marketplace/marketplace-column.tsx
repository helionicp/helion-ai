...
interface MarketplaceColumnProps extends Pick<FlexProps, 'children' | 'w' | 'gap'> {
  id: string;
  title: string;
}

export function MarketplaceColumn({ children, title, w = '18rem', gap = 'sm' }: MarketplaceColumnProps) {
  return (
    <Card p="sm">
